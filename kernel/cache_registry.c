...
extern const unsigned char cache_module_quicksort[];
extern const unsigned int cache_module_quicksort_size;
extern const unsigned char cache_module_sha256[];
extern const unsigned int cache_module_sha256_size;
extern const unsigned char cache_module_strops[];
extern const unsigned int cache_module_strops_size;
...
void cache_registry_foreach(cache_registry_iter_fn fn, void* ctx) {
    ...
    fn("quicksort", cache_module_quicksort, cache_module_quicksort_size, ctx);
    fn("sha256", cache_module_sha256, cache_module_sha256_size, ctx);
    fn("strops", cache_module_strops, cache_module_strops_size, ctx);
